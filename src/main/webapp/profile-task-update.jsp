            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 id="tittle-content" class="page-title">Cập nhập trạng thái công việc</h4>
                    </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="project-name" type="text" readonly class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Tên công việc</label>
                                    <div class="col-md-12">
                                        <input id="task-name" type="text" readonly class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input id="task-start-date" type="text" readonly class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input id="task-end-date" type="text" readonly class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Trạng thái</label>
                                    <div class="col-md-12">
                                        <select id="select-task" class="form-control form-control-line">
...
<%--                                            <option value="3">Đã hoàn thành</option>--%>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button id="btn-save-status" type="submit" class="btn btn-success">Cập nhập</button>
                                        <a href="http://localhost:${pageContext.request.serverPort}/profile" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script src="js/profile-task-update.js" ></script>
</body>
