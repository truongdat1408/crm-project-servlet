                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="input-fullname" type="text" placeholder="Ed Sheeran"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Email</label>
                                    <div class="col-md-12">
                                        <input id="input-email" type="email" placeholder="teddyB@admin.com"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Password</label>
                                    <div class="col-md-12">
                                        <input id="input-password" type="password" placeholder="******" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Confirm Password</label>
                                    <div class="col-md-12">
                                        <input id="input-confirm-password" type="password" placeholder="******" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Avatar</label>
                                    <div class="col-md-12">
                                        <input id="input-avatar" type="text" placeholder="image.jpg"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select id="select-role" class="form-control form-control-line">
...
<%--                                            <option>Thailand</option>--%>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button id="btn-add-user" type="submit" class="btn btn-success">Thêm thành viên</button>
                                        <a href="http://localhost:${pageContext.request.serverPort}/user" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
