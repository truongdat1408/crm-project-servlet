            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 id="page-title" class="page-title">Chi tiết dự án </h4>
                        <div>
                            <h5 id="title-name-leader" class="page-aside"></h5>
                            <h5 id="title-start-date" class="page-aside"></h5>
                            <h5 id="title-end-date" class="page-aside"></h5>
                        </div>
                    </div>
                ...
                <div id="task-detail" class="row">
<%--                    <div class="col-xs-12">--%>
<%--                        <a href="#" class="group-title">--%>
<%--                            <img width="30" class="img-circle" />--%>
<%--                            <span>N/A</span>--%>
<%--                        </a>--%>
<%--                    </div>--%>
<%--                    <div class="col-md-4">--%>
