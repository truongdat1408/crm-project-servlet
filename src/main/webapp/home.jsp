                    ...
                    <li>
                        <div class="dropdown">
                            <a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#"> 
                                <img id="user-avatar" alt="user-img" width="36" class="img-circle" />
                    ...
                    <div class="white-box">
                        <div class="col-in row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <h3 id="task-unbegun" class="text-right m-t-15 text-danger">0</h3>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="progress">
                                    <div id="progress-bar-unbegun" class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="0"
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="white-box">
                        <div class="col-in row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <h3 id="task-doing" class="text-right m-t-15 text-megna">0</h3>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="progress">
                                    <div id="progress-bar-doing" class="progress-bar progress-bar-megna" role="progressbar" aria-valuenow="0"
                                        aria-valuemin="0" aria-valuemax="100" style="width: 0%"> <span
                                            class="sr-only">40% Complete (success)</span> </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="white-box">
                        <div class="col-in row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <h3 id="task-finish" class="text-right m-t-15 text-primary">0</h3>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="progress">
                                    <div id="progress-bar-finish" class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="0"
                                        aria-valuemin="0" aria-valuemax="100" style="width: 0%"> <span
                                            class="sr-only">40% Complete (success)</span> </div>
                                </div>
                            </div>
