                        ...
                        <li>
                            <div class="dropdown">
                                <a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#"> 
                                    <img id="user-avatar-bar" alt="user-img" width="36" class="img-circle" />
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 id="title-content" class="page-title">Chỉnh sửa công việc</h4>
                    </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select id="select-project" class="form-control form-control-line">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="input-task-name" type="text" placeholder="Tên công việc"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select id="select-member" class="form-control form-control-line">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="input-start-date" type="date" placeholder="dd/MM/yyyy"
                                               class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="input-end-date" type="date" placeholder="dd/MM/yyyy"
                                               class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select id="select-status" class="form-control form-control-line">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button id="btn-edit-task" type="submit" class="btn btn-success">Chỉnh sửa</button>
                                        <a href="http://localhost:${pageContext.request.serverPort}/task" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
