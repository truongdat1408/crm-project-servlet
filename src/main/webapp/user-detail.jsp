            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 id="page-title" class="page-title">Chi tiết thành viên</h4>
                    </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="plugins/images/large/apple.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img id="member-avatar"
                                                class="thumb-lg img-circle" alt="img"></a>
                                        <h4 id="member-name" class="text-white">N/A</h4>
                                        <h5 id="member-email" class="text-white">N/A</h5>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div id="list-unbegun" class="message-center">
<%--                                <a href="#">--%>
...
<%--                                </a>--%>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div id="list-doing" class="message-center">
<%--                                <a href="#">--%>
<%--                                    <div class="mail-contnet">--%>
<%--                                        <h5>Phân tích hệ thống</h5>--%>
<%--                                        <span class="mail-desc"></span>--%>
...
<%--                                </a>--%>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div id="list-finish" class="message-center">
<%--                                <a href="#">--%>
<%--                                    <div class="mail-contnet">--%>
<%--                                        <h5>Phân tích hệ thống</h5>--%>
<%--                                        <span class="mail-desc"></span>--%>
