                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Quản lý</label>
                                    <div class="col-md-12">
                                        <select id="select-leader" class="form-control form-control-line">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button id="btn-add-project" type="submit" class="btn btn-success">Thêm dự án</button>
                                        <a href="http://localhost:${pageContext.request.serverPort}/project" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
